...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument("--numClass", type=int, default=3)
		...
		self.parser.add_argument('--model', type=str, default='yolov3', help='yolov3, refine')
		self.parser.add_argument("--dataset_mode", default="visDrone", help="specify the type of custom dataset to create (crop | list | test | test_crop)")
